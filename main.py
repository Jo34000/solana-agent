...
def main() -> int:
    ...
    if mode == "probe_universe_v6":
        import probe_universe_v6

        probe_universe_v6.main()
        log.info("Fin de run (%s).", mode)
        return 0

    if mode == "probe_universe_v5":
        import probe_universe_v5

        probe_universe_v5.main()
        log.info("Fin de run (%s).", mode)
        return 0

    if mode == "probe_universe_v4":
        import probe_universe_v4

        probe_universe_v4.main()
        log.info("Fin de run (%s).", mode)
        return 0
